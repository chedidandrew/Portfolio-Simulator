...
import { Moon, Sun, TrendingUp, TrendingDown, BookOpen, Settings, Check, CreditCard, Heart, RotateCcw, ChevronRight, LayoutGrid } from 'lucide-react'
      ...
      <main className="container mx-auto max-w-6xl px-4 py-4 pb-16 sm:py-6 sm:pb-20 print:p-0 print:max-w-none">
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          ...
          <TabsContent value="guide" className="mt-0">
            <div className="mb-4 flex items-center justify-end print:hidden sm:mb-6">
